...
module InheritedResources
  ...
  module BaseHelpers
    ...
    protected
      ...
      #
      def resource
        Rails.logger.debug "IH: end_of_association_chain: #{end_of_association_chain}"
        Rails.logger.debug "IH: params: #{params}"
        Rails.logger.debug "IH: method_for_find: #{method_for_find}"
    ...
    private
      ...
      def get_resource_ivar #:nodoc:
        Rails.logger.debug "IH: actual variable value: #{instance_variable_get("@#{resource_instance_name}")}"
      ...
      def set_resource_ivar(resource) #:nodoc:
        Rails.logger.debug "IH: resource_instance_name: #{resource_instance_name}"
        Rails.logger.debug "IH: setting resource variable for resource: #{resource.inspect}"
